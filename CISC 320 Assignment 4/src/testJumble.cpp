...
void testJumble() {
	// Custom Tests
	try {
		JumblePuzzle test("1+dsa$&", "easy");
	} catch (BadJumbleException& e) {
		cout << "Invalid character input PASSED" << endl;
	}
	try {
		JumblePuzzle test("hello", "aaaaaaa");
	} catch (BadJumbleException& e) {
		cout << "Invalid difficulty input PASSED" << endl;
	}
	try {
		JumblePuzzle test("o", "easy");
	} catch (BadJumbleException& e) {
		cout << "Invalid minimum length input PASSED" << endl;
	}
	try {
		JumblePuzzle test("aaaaaaaaaaaaaaaaaaaaa", "easy");
	} catch (BadJumbleException& e) {
		cout << "Invalid maximum input PASSED" << endl;
	}
